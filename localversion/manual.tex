...
If the sample includes a word that can be added to the language, then the language is definitely not maximal and I-LaSer will provide the word that can be added.
...
When entering a mathematical regular expression, the only operators allowed are:
\begin{itemize}
...
Similarly to the automaton format, the transducer input starts with the word @Transducer, a list of ending states, and optionally, a list of starting states and an alphabet.
...
For example, the below transducer, when given the word "001", outputs "001", "101", "011", and "111".
\begin{center}
@Transducer 0\\
0 0 0 0\\
0 0 1 0\\
...
For more detail on trajectory expressions, see %cite the Domaratzki paper

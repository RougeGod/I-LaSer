...
class UploadFileForm(forms.Form):
    ...
    def clean(self):
        ...
        if not data.get('transducer_text'):
            if not result.get('transducer') and not result.get('fixed_type') and not result.get('trajectory'):
        ...
        data['automata_text'] = str(data['automata_text'])

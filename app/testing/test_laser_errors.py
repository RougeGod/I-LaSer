...
TEST_FILES_FA = ["test_files/NFA-a(aa)#.fa", "test_files/error/MultipleFA.fa"]
...
#test for input-altering properties when input preserving property is selected

#test AMAX without required parameters
...
#test for IAT being entered when IPT is specified, and vice versa